...
class Cannon(
    ...
    fun fireCannonball() {
        ...
        val velocityX = (com.example.zad4.ui.game.CannonView.CANNONBALL_SPEED_PERCENT *
                view.screenWidth * Math.sin(barrelAngle)).toInt()

        // calculate the Cannonball velocity's y component
        val velocityY = (com.example.zad4.ui.game.CannonView.CANNONBALL_SPEED_PERCENT *
        ...
        cannonball = Cannonball(
            view, Color.BLACK,
            com.example.zad4.ui.game.CannonView.CANNON_SOUND_ID, -radius,
    ...
    fun draw(canvas: Canvas) {
        // draw cannon barrel
        canvas.drawLine(
            0f, (view.screenHeight as Int / 2).toFloat(), barrelEnd.x.toFloat(),
